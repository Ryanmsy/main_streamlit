...
st.write("Streamlit app is build with Claude Code. Everything else was my interest ")
...
with col1:
    ...
    st.write("Compare two models: SVM and Transformer — trained on Amazon product reviews. Input any text and see how each model classifies the sentiment.")
